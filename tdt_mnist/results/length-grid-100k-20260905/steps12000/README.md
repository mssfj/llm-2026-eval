...
| ---: | ---: | ---: | ---: | ---: | ---: |
| 64 | 8 | 86.57 ± 1.01 | 87.57 ± 0.31 | 11996.7 ± 1.5 | 3/3 |
| 128 | 8 | 84.33 ± 1.45 | 85.95 ± 0.45 | 11999.3 ± 0.6 | 3/3 |
| 256 | 8 | 81.80 ± 1.30 | 83.92 ± 0.56 | 12000.0 ± 0.0 | 3/3 |
...
| ---: | ---: | ---: | ---: | ---: | ---: |
| 64 | 8 | -0.036 | 5.148 | 59 | 0.000 |
| 128 | 8 | -0.012 | 5.010 | 63 | 0.000 |
| 256 | 8 | -0.006 | 4.914 | 45 | 0.000 |

全seedの値はper_seed.csv、平均と標準偏差はaggregate.csv。
詳細ログ・設定・学習済み重み: `/root/lowbit-math-reasoning/tdt_mnist/runs/length-grid-100k-20260905/steps12000`
