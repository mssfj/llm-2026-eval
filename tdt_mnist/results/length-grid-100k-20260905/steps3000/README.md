...
| ---: | ---: | ---: | ---: | ---: | ---: |
| 64 | 8 | 77.00 ± 0.92 | 77.65 ± 0.72 | 2997.7 ± 0.6 | 3/3 |
| 128 | 8 | 71.27 ± 1.30 | 72.09 ± 2.00 | 2999.3 ± 0.6 | 3/3 |
| 256 | 8 | 63.93 ± 2.20 | 64.50 ± 3.15 | 3000.0 ± 0.0 | 3/3 |
...
| ---: | ---: | ---: | ---: | ---: | ---: |
| 64 | 8 | -0.015 | 5.287 | 59 | 0.000 |
| 128 | 8 | -0.002 | 5.019 | 63 | 0.000 |
| 256 | 8 | -0.004 | 4.866 | 45 | 0.000 |

全seedの値はper_seed.csv、平均と標準偏差はaggregate.csv。
詳細ログ・設定・学習済み重み: `/root/lowbit-math-reasoning/tdt_mnist/runs/length-grid-100k-20260905/steps3000`
