...
def main():
    ...
    for r in records:
        ...
        for obs in signals:
            ...
            if config['hidden_activation']=='relu' and obs['stage']=='output' and layer<depth-1: assert float(obs['negative_fraction'])==0
            if config['activation_precision']=='a32' and obs['stage']=='input' and layer:
